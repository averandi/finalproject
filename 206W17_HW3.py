...
## Any names of people you worked with on this assignment: Danielle, 
...
test1 = '5 watermelons, 13 pineapples, and 1 papaya.'
test2 = '101 dalmations!'
test3 = "This is Ava's made up test string"
print(parse_counted_words(test1))
print(parse_counted_words(test2))
print(parse_counted_words(test3))
