...
def get_user_tweets(twenty_user_timeline_tweets):
	#full_url = api.user_timeline(q = search_tweets)
	unique_identifier = "twitter_{}".format(twenty_user_timeline_tweets)
	
	if unique_identifier in CACHE_DICTION: 
		print('using cached data for', twenty_user_timeline_tweets)
...
cur.execute('CREATE TABLE Tweets (tweet_id TEXT, author TEXT, time_posted INTEGER, tweet_text TEXT, retweets INTEGER)')
