...
## Any names of people you worked with on this assignment: Piazza, Samii Stoloff
...
class Student():
    ...
    def write_programs(self, optparam = 1):
        self.num_programs = self.num_programs + optparam
...
def personal_map(func_obj, lst):
    ys = []
    for x in lst:
        ys.append(func_obj(x))
    return ys
